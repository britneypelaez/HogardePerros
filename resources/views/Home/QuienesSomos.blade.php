    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="5000">
                <img src="{{ asset('img/Home/perros1.jpeg') }}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item"  data-bs-interval="5001">
                <img src="{{ asset('img/Home/gatoo.png') }}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="5002">
                <img src="{{ asset('img/Home/perros2.jpeg') }}" class="d-block w-100" alt="...">
            </div>
        </div>
