...
class MascotaPerdida extends Model
{
    ...
    {
        return $query->select('mascotas_perdidas.*', 'raza.descripcion AS rasa', 'color.descripcion AS colorin')->join('raza', 'mascotas_perdidas.raza', '=', 'raza.raza')->join('color', 'mascotas_perdidas.color', '=', 'color.color')->where('mascotas.estado', '=', 4);
    }
